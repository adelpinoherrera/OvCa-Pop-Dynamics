function result = run_coculture_adaptive_simulation_new(S0, R0, u0, threshFrac)
    ...
    csvname = sprintf('output_adaptive/adaptive_S0_%0.0f_R0_%0.0f_u0_%0.2f_thresh_%0.2f.csv', ...
        S0, R0, u0, threshFrac);
    ...
    png = sprintf('output_adaptive/adaptive_S0_%0.0f_R0_%0.0f_u0_%0.2f_thresh_%0.2f.png', ...
        S0, R0, u0, threshFrac);
