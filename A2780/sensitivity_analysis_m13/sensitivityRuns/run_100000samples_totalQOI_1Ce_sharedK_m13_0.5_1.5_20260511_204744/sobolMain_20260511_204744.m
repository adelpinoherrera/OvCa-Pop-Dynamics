...
outdir = fullfile('sensitivityRuns', ['run_100000samples_totalQOI_1Ce_sharedK_m13_0.5_1.5_', timestamp]);
mkdir(outdir);
...
plot_top_params(11, S1_sorted, ST_sorted, paramNames_sorted)
...
exportgraphics(gcf, 'sensitivity_plot_1Ce_sharedK.png', 'Resolution', 300);