...
outdir = fullfile('sensitivityRuns', ['run_100000samples_totalQOI_0Ce_sharedK_m13_0.5_1.5_', timestamp]);
mkdir(outdir);
...
exportgraphics(gcf, 'sensitivity_plot_0Ce_sharedK.png', 'Resolution', 300);