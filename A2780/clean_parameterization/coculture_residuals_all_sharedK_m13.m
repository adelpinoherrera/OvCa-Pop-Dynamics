function [res, BIC_conditions] = coculture_residuals_all_sharedK_m13(p, rS, alphaS, nS, IC50S, rR, alphaR, nR, IC50R, ...
    ...
    for i = 1:6
        ...
        for j = 1:nReps
            ...
            [S_mod, R_mod] = simulate_coculture_sharedK_m13(t_data, S0, R0, rS, alphaS, nS, IC50S, ...
                rR, K, alphaR, nR, IC50R, ce_all(i));
