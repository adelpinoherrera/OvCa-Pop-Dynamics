function [res, BIC_conditions] = coculture_residuals_all_sens2_m13(p, nS, IC50S, alphaR, nR, IC50R, ...
    ...
    for i = 1:6
        ...
        for j = 1:nReps
            ...
            [S_mod, R_mod] = simulate_coculture_sens2_m13(t_data, S0, R0, rS, K, alphaS, nS, IC50S, ...
                rR, alphaR, nR, IC50R, ce_all(i));
