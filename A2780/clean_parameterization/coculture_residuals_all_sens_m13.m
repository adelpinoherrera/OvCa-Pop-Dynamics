function [res, BIC_conditions] = coculture_residuals_all_sens_m13(p, nS, IC50S, delta, KR, alphaR, nR, IC50R, gamma, ...
    ...
    for i = 1:6
        ...
        for j = 1:nReps
            ...
            [S_mod, R_mod] = simulate_coculture_sens_m13(t_data, S0, R0, rS, KS, delta, alphaS, nS, IC50S, ...
                rR, KR, gamma, alphaR, nR, IC50R, ce_all(i));
