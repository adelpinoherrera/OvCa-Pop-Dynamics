function result = run_coculture_adaptive_simulation2_new(S0, R0, u0, threshFrac)
    % Inputs:
    ...
    csvname = sprintf('output_adaptive2/adaptive_new_S0_%0.0f_R0_%0.0f_u0_%0.2f_thresh_%0.2f.csv', ...
        S0, R0, u0, threshFrac);
    ...
    png = sprintf('output_adaptive2/adaptive_new_S0_%0.0f_R0_%0.0f_u0_%0.2f_thresh_%0.2f.png', ...
        S0, R0, u0, threshFrac);
    exportgraphics(fig, png, 'Resolution', 300);
end

%to run the function do this resul =
%run_coculture_adaptive_simulation2_new(15000, 15000, 1.0, 0.5);
