function [res, BIC_IC50, BIC_IC25, BIC_IC75] = all_datasets_residual_reps_n_and_alpha_constD_add_only_n(p, rS, KS, IC50, ...
                                         t1,S1_raw,ce1, ...
                                         t2,S2_raw,ce2, ...
                                         t3,S3_raw,ce3)
    n = p(1);
    ...
    for j = 1:nReps1
        ...
        S1_model = simulate_treat_for_dataset_withConstantD_add_only_n(n, t1, S01, ce1, rS, KS, IC50);
    ...
    for j = 1:nReps2
        ...
        S2_model = simulate_treat_for_dataset_withConstantD_add_only_n(n, t2, S02, ce2, rS, KS, IC50);
    ...
    for j = 1:nReps3
        ...
        S3_model = simulate_treat_for_dataset_withConstantD_add_only_n(n, t3, S03, ce3, rS, KS, IC50);
