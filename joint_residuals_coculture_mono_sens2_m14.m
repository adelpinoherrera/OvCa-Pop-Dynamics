function [res, BIC_info] = joint_residuals_coculture_mono_sens2_m14( ...
    ...
    for i = 1:numel(S_co_all)
        ...
        for j = 1:nReps
            ...
            [S_mod, R_mod] = simulate_coculture_all_sens2_m14( ...
                t_co, S0, R0, rS, K, alphaS, IC50S, ...
                rR, alphaR, IC50R, ce_co(i));
    ...
    for i = 1:numel(S_mono_all)
        ...
        for j = 1:nReps
            S0 = S_raw(1,j);
            S_mod = simulate_mono_sens2_m14( ...
                t_mono_S, S0, rS, K, alphaS, IC50S, ce_mono_S(i));
    ...
    for i = 1:numel(R_mono_all)
        ...
        for j = 1:nReps
            R0 = R_raw(1,j);
            R_mod = simulate_mono_res_sens2_m14( ...
                t_mono_R, R0, rR, K, alphaR, IC50R, ce_mono_R(i));
