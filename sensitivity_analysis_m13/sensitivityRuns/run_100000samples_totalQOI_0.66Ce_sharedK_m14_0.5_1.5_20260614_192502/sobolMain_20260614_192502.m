...
outdir = fullfile('sensitivityRuns', ['run_100000samples_totalQOI_0.66Ce_sharedK_m14_0.5_1.5_', timestamp]);
mkdir(outdir);
...
base_samples = 100000; %100 samples or 100,000 samples ? 
param_dist = {'Uniform'};
...
S1 = cell2mat(S.S1);
ST = cell2mat(S.ST);
%load the data, load both .mat files titled sensitivity_results
%p_struct = load(fullfile('sensitivityRuns', 'run_100000samples_totalQOI_0Ce_m13_0.8_1.2_20260428_143826', 'params_used.mat'));
%paramNames = fieldnames(p_struct)
...
plot_top_params(9, S1_sorted, ST_sorted, paramNames_sorted)
...
exportgraphics(gcf, 'sensitivity_plot_0.66Ce_sharedK.png', 'Resolution', 300);